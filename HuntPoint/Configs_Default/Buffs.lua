HuntPoint.Buffs[44] = {                         -- N˙mero do buff no Effect.txt
...
HuntPoint.Buffs[45] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[46] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[47] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[48] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[49] = {	                        -- N˙mero do buff no Effect.txt
    AllowUp = true,		                        -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[89] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[90] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[114] = {                         -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
...
HuntPoint.Buffs[121] = {                        -- N˙mero do buff no Effect.txt
    AllowUp = true,                             -- true > ativa o up | false > desativa o up
