ResetRebuild[0] = {
	LevelUpPoint = ConfigReadNumber("GameServerInfo", "DWLevelUpPoint", "DATA/GameServerInfo - Common.dat"), -- normal up points
	ExtraPointQuest = ConfigReadNumber("GameServerInfo", "PlusStatPoint", "DATA/GameServerInfo - Common.dat"), -- 2º class extra up points
	Type = {
		[0] = 2, -- Free
		[1] = 2, -- Vip1
		[2] = 2, -- Vip2
