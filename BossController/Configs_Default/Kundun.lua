BossController.BossList[275] = {} -- Configuration initializer with monster id

BossController.BossList[275][1] = {} -- Initialize monster configuration key
BossController.BossList[275][1].Name = nil -- Custom monster name  - put nil to use default monster name
BossController.BossList[275][1].Message = {
...
BossController.BossList[275][1].Location = {
    -- Places where this setting is valid
    [36] = {MapXMin = 0, MapXMax = 255, MapYMin = 0, MapYMax = 255}
}
BossController.BossList[275][1].AnnounceKiller = true -- true > enable boss death notification | false > disable
BossController.BossList[275][1].AnnounceRespawn = false -- true > enable notification when there are 5 minutes left to respawn | false > disable
...
BossController.BossList[275][1].KillMoveLocation = {} -- List of moves it will be sent to after the KillMoveTime time expires
--example [36] = {Map = 0, MapX = 125, MapY = 125}
BossController.BossList[275][1].NPC = {
    -- NPC Settings
...
BossController.BossList[275][1].RewardParty = {
...
BossController.BossList[275][1].RewardExtra = {} -- Extra settings for whoever made the final blow
BossController.BossList[275][1].RewardNoOwner = {} -- Ownerless configurations that stay on the ground for a while without being able to pick up, soon after time, anyone can pick up
BossController.BossList[275][1].ItemDropBossCount = {0, 0} -- {Minimum,Maximum} of items that will drop ( ItemDropSystem script required ) | false > disable
